// =========================================================
// 💒 [강남담당 통합 대시보드 - 혼수/웨딩 패키지 정책 데이터 (8월 업데이트)]
// =========================================================

const WEDDING_POLICY = {
    // 8월 고정 플랜: 웨딩 80 플랜 TV 모델 변경(75QNED86B -> 75MRGB86B)
    fixedPlans: [
    ...
    // 8월 BEST-PICK 모델 목록 업데이트
    bestPickModels: {
        tv: [
            "OLED77C6Q", "75MRGB86B", "OLED83C6Q", "86MRGB86B", "OLED65C6S", "32LX6BPGA" // MRGB 2종 및 스탠바이미2 Max 추가
        ],
        fridge: [
            "G646GBB031", "M876GBB231", "H876GBB111", "G646GBB091", "M876GBB181", "D646GBB091" // 드로어 추가
        ],
        washer: [
            // 8월 신모델 5종으로 개편
